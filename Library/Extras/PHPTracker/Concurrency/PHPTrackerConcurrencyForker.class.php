 ...
 */
abstract class PHPTrackerConcurrencyForker{
    /**
    ...
    final public function startDetached(){
        ...
        $sid=posix_setsid();
        if(false===$sid){
            throw new PHPTrackerConcurrencyException( 'Unable to become session leader (detaching).' );
        }
     ...
     *
     * @throws PHPTrackerConcurrencyException When forking is unsuccessful.
     ...
     *
     * @throws PHPTrackerConcurrencyException if the forking is unsuccessful.
    ...
    protected function fork(){
        ...
        if(-1==$pid){
            throw new PHPTrackerConcurrencyException( 'Unable to fork.' );
        }
        return $pid;
    }
}
