...
class PHPTrackerFile{
     ...
     *
     * @throws PHPTrackerFileExceptionNotExits If the file does not exists.
     * @param string $path
     */
    ...
    public function size(){
        if(false===($size=@filesize($this->path))){
            throw new PHPTrackerFileUnreadableException( "File $this is unreadable." );
        }
        return $size;
    }
     ...
     *
     * @throws PHPTrackerFileUnreadableException If the file can't be read.
     * @return resource
     */
     ...
     *
     * @throws PHPTrackerFileExceptionNotExits
     */
    protected function shouldExist(){
        if(!$this->exists()){
            throw new PHPTrackerFileExceptionNotExits( "File $this does not exist." );
        }
    }
}
