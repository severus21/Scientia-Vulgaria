 ...
 * @subpackage Seeder
 */
class PHPTrackerSeederServer extends PHPTrackerConcurrencyForker{
    /**
    ...
    public function startChildProcess($slot){
        ...
        if($persistence instanceof PHPTrackerPersistenceResetWhenForking){
        ...
        switch($slot){
            ...
            case 1:
                ...
                break;
            default:
                throw new PHPTrackerException('Invalid process slot while running seeder server.');
        }
    }
